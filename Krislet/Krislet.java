...
class Krislet implements SendCommand {
    ...
    //---------------------------------------------------------------------------
    // Explicit close instead of finalize()
    public void close() {
        m_socket.close();
    }
    ...
    // Original single-argument dash (forward)
    public void dash(double power) {
        send("(dash " + Double.toString(power) + ")");
    }

    // New two-argument dash (directional), used by Brain
    ...
    //===========================================================================
    // Here comes collection of communication functions
